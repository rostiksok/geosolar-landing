      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
          <section>
            ...
            <p>
              ТОВ «<span className="text-[#1B2A4A]">Geo</span>
              <span className="text-[#E8922D]">Solar</span>» здійснює постачання обладнання для сонячних електростанцій
              на території України. Усі товари сертифіковані та відповідають стандартам.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li>
                <strong>Huawei</strong> — мережеві інвертори серії SUN2000 потужністю від 5 кВт
              </li>
              <li>
                <strong>Longi Solar</strong> — монокристалічні панелі потужністю 435Вт до 650 Вт
              </li>
              <li>
                <strong>Solis</strong> — мережеві інвертори потужністю від 5 кВт
              </li>
              <li>
                <strong>Deye</strong> — мережеві інвертори потужністю від 5 кВт
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Монтаж виконується кваліфікованою бригадою <span className="text-[#1B2A4A]">Geo</span>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Монтажні роботи — гарантія <span className="text-[#1B2A4A]">Geo</span>
                <span className="text-[#E8922D]">Solar</span> 1 рік
              </li>
            </ul>
          </section>
