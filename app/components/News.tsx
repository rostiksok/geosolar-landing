...
const news = [
  {
    ...
    excerpt:
      "Панелі Longi мають ККД 23.3% — це максимум на сьогодні. Інвертор Huawei працює без вентиляторів, що виключає поломки. Завдяки точному геодезичному зніманню від GeoSolar, ви повертаєте інвестиції менш ніж за 4 роки.",
    image: "/hero-img.png",
  },
  {
    id: 2,
    ...
    excerpt:
      "Все починається з точних геодезичних вимірювань. Ми знімаємо ділянку, підбираємо обладнання Huawei та Longi, виконуємо монтаж та оформлюємо «Зелений тариф». Проєкти від 5кВт до 1000кВт і більше.",
          ...
          {news.map((item, i) => (
            <div
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-600 leading-relaxed">{styleGeoSolar(item.excerpt)}</p>
              </div>
            </div>
          ))}
        </div>
