  ...
  const steps = [
    {
      ...
      description:
        "Професійно знімаємо ділянку для розрахунку ідеальних кутів нахилу та уникнення затінень. Кожен ватт працюватиме на вас.",
    },
    {
      id: "02",
      title: "Розрахунок оптимального розміщення",
      description:
        "На основі геодезичних даних створюємо модель станції з максимальною генерацією та швидкою окупністю.",
    },
    {
      id: "03",
    ...
    },
    {
      ...
      description:
        "Повний юридичний супровід — від дозволів до підключення та оформлення «Зеленого тарифу» для стабільного доходу.",
    },
  ];
  ...
  return (
    <section className="py-8 bg-[#FFF8F0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2
          ref={titleRef}
          className={`text-3xl md:text-5xl font-bold text-black uppercase leading-tight mb-16 max-w-4xl animate-fade-up ${titleInView ? "in-view" : ""}`}>
        ...
        <div ref={contentRef} className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            {steps.map((step, i) => (
              <div
                key={step.id}
                className={`flex gap-6 animate-fade-left ${contentInView ? "in-view" : ""}`}
                style={{ transitionDelay: `${i * 80}ms` }}>
                <div className="flex-shrink-0 w-10 text-[#E8922D] font-bold text-xl pt-1">{step.id}</div>
                <div>
