    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" id="home">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center py-32">
        <div ref={ref} className="max-w-4xl mx-auto bg-white/50 backdrop-blur-md rounded-3xl p-8 md:p-12 shadow-xl">
          <h1 className={`text-4xl md:text-7xl font-extrabold text-[#1B2A4A] mb-6 uppercase tracking-tight animate-fade-up ${inView ? "in-view" : ""}`} style={{ textShadow: '0 2px 8px rgba(255,255,255,0.8)' }}>
            Від ділянки <br />до розетки
          </h1>
          <p className={`text-xl md:text-2xl font-bold text-[#1B2A4A]/90 mb-4 animate-fade-up delay-200 ${inView ? "in-view" : ""}`} style={{ textShadow: '0 1px 6px rgba(255,255,255,0.7)' }}>
          ...
          <div className={`flex flex-col sm:flex-row justify-center gap-4 md:gap-6 animate-fade-up delay-400 ${inView ? "in-view" : ""}`}>
            <Link
              href="#calculator"
