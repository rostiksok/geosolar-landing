    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" id="home">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center py-32">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-7xl font-extrabold text-[#1B2A4A] mb-6 uppercase tracking-tight drop-shadow-sm">
            Від ділянки <br />до розетки
          </h1>
          <p className="text-xl md:text-2xl font-bold text-black/80 mb-4 drop-shadow-sm">
