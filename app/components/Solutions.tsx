  ...
  return (
    <section className="py-16 bg-[#0B1221] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={headRef} className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div>
            <h2 className={`text-3xl md:text-5xl font-bold uppercase leading-tight mb-8 animate-fade-up ${headInView ? "in-view" : ""}`}>
              Від ділянки <br />
            ...
            <Link
              ...
              className={`inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 border border-transparent text-lg font-bold rounded-full text-white bg-[#E8922D] hover:bg-[#d17f1f] transition-all shadow-lg active:scale-95 active:shadow-inner animate-fade-up delay-200 ${headInView ? "in-view" : ""}`}
            >
              Безкоштовна консультація
            </Link>
          </div>
          
          <div className={`flex flex-col justify-center animate-fade-left ${headInView ? "in-view" : ""}`}>
        ...
        {/* 3 Pillars */}
        <div ref={pillarsRef} className="bg-white rounded-3xl p-8 md:p-12 text-black grid grid-cols-1 md:grid-cols-3 gap-8">
           {/* Pillar 1: ДІЛЯНКА */}
           <div className={`space-y-4 animate-fade-up ${pillarsInView ? "in-view" : ""}`}>
           ...
           {/* Pillar 2: ПРОЄКТ */}
            <div className={`space-y-4 animate-fade-up delay-200 ${pillarsInView ? "in-view" : ""}`}>
              <div className="w-16 h-16 bg-transparent">
           ...
           {/* Pillar 3: РОЗЕТКА */}
            <div className={`space-y-4 animate-fade-up delay-400 ${pillarsInView ? "in-view" : ""}`}>
              <div className="w-16 h-16 bg-transparent">
